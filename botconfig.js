module.exports = {
  Admins: ["708983835018395679", "842620032960823327"], //Admins of the bot
  ...
  Token: process.env.Token || "OTYxODI3MTA5MDEyMTM1OTY2.Yk-pTA.uQ_9kx4zLde99IdT758y6vl0jVo", //Discord Bot Token
  ClientID: process.env.Discord_ClientID || "961827109012135966", //Discord Client ID
  ClientSecret: process.env.Discord_ClientSecret || "eFddV6s28Kjvw2vWvmgCQc0DRTqfeJYm", //Discord Client Secret
